...
/* -- dirver configure -- */
#define CFG_SUPPORT_AUTO_UPG    0  //lzk  0
#define CFG_SUPPORT_UPDATE_PROJECT_SETTING  0
#define CFG_SUPPORT_TOUCH_KEY   0  //1    //touch key, HOME, SEARCH, RETURN etc   //lzk ceshi

#define CFG_MAX_TOUCH_POINTS   10 // max:16   //lzk 
#define CFG_NUMOFKEYS    0 //4                
#define CFG_FTS_CTP_DRIVER_VERSION "3.0"

#define FT_MAX_ID	0x0F
#define FT_TOUCH_ID_POS			5
#define FT_TOUCH_STEP	4  //6
...
#define GPIO_IRQ 		(130+3) //GPIO_S5[3]
#define GPIO_RST		(102+26) //GPIO_S0_NC[26]
#define SCREEN_MAX_X    1920    //1024  lzk 
#define SCREEN_MAX_Y    1200       //1200          //600
#define PRESS_MAX       255

#define CFG_POINT_READ_BUF  (3 + 8 * (CFG_MAX_TOUCH_POINTS))  //6
