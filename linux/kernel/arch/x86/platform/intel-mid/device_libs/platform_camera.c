...
static struct camera_device_table byt_crv2_cam_table[] = {
	{
		...
		{SFI_DEV_TYPE_I2C, 3, 0x36, 0x0, 0x0, "ov5648"},
		...
		{SFI_DEV_TYPE_I2C, 2, 0x36, 0x0, 0x0, "ov2680f"},
...
int camera_set_pmic_power(enum camera_pmic_pin pin, bool flag)
{
	...
	//u8 reg_addr[CAMERA_POWER_NUM] = {VPROG_1P8V, VPROG_2P8V};
	//u8 reg_value[2] = {VPROG_DISABLE, VPROG_ENABLE};
	u8 reg_addr[CAMERA_POWER_NUM] = {0x12, 0x13, 0x12};
	u8 reg_value[3] = {0x2, 0x20, 0x01};
	u8 reg_adjust_addr[3] = {0x1A, 0x28, 0x19};
	u8 reg_adjust_value[3] = {22, 21, 16}; /* 1.8v for ELDO2, 2.8v for ALDO1 */
